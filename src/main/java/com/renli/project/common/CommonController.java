...
import com.renli.common.utils.file.FileUtils;
import com.renli.framework.config.RenLiConfig;
import com.renli.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = RenLiConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        ...
        {
            // 上传文件路径
            String filePath = RenLiConfig.getUploadPath();
            // 上传并返回新文件名称
